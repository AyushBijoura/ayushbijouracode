...
&nbsp;
	<ul>
		...
		<div style="position: absolute; width: 1146px; height: 32px; z-index: 3; left: 197px; top: 161px" id="fashion">
			...
			WEDDING &gt; WEDDING SHOOTS</span></b><p>&nbsp;</div>
	<div style="position: absolute; width: 1145px;  z-index: 4; left: 194px; top: 229px" id="fmw">
<?php

$query = "select * from weddingshoots order by wedd_id DESC";
...
?>
		...
		<a href="upload_weddingshoots/<?php echo $image; ?>"><img src="upload_weddingshoots/<?php echo $image; ?>"  height="250"  width="250" id="fetch_image"/></a>
