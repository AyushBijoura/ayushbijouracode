...
&nbsp;
	<ul>
		...
		<div style="position: absolute; width: 1146px; height: 32px; z-index: 3; left: 197px; top: 161px" id="fashion">
			...
			&nbsp;&nbsp;&nbsp;
			HOME &gt;</b> <b>
			<span style="color: rgb(56, 56, 56); font-family: Arial, verdana, arial, sans-serif; font-size: 14px; font-style: italic; font-variant: small-caps; letter-spacing: normal; line-height: 21px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">EVENTS</span></b><p>&nbsp;</div>
	<div style="position: absolute; width: 1145px;  z-index: 4; left: 194px; top: 229px" id="fmw">

      <?php
include("includes/connect.php");
$query = "select * from event order by events_id DESC";
$run = mysql_query($query);
while ($row=mysql_fetch_array($run))
	{
	 $post_id = $row['events_id'];
...
?>
		...
		<a href="upload_event/<?php echo $image; ?>"><img src="upload_event/<?php echo $image; ?>"  height="250"  width="250" id="fetch_image"/></a>
