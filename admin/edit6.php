...
$query = "select * from children where child_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['child_id'];
...
<html>
	...
	<body>
	<form method="post" action="edit6.php?edit_form=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
	...
	<td>Post image:</td>
			...
			<img src="../upload_child/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
		...
		if($post_image_size<=9000000)
			{
						...
						move_uploaded_file($post_image_tmp,"../upload_child/$post_image");
						$update_query="update children set child_image='$post_image'where child_id='$update_id'";
