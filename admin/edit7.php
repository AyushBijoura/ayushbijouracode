...
$query = "select * from prepostwed where prew_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['prew_id'];
...
<html>
	...
	<body>
	<form method="post" action="edit7.php?edit_form=<?php echo $edit_id1 ;?>" enctype="multipart/form-data">
	...
	<td>Post image:</td>
			...
			<img src="../upload_prepostwed/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
...
if(isset($_POST['update']))
{
	...
	if($post_image_size<=80000000)
			{
			
					move_uploaded_file($post_image_tmp,"../upload_prepostwed/$post_image");

	$update_query="update prepostwed set prew_image='$post_image'where prew_id='$update_id'";
