...
$query = "select * from weddingshoots where wedd_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['wedd_id'];
				$image = $row['wedd_image'];
...
<html>
	...
	<body>
	<form method="post" action="edit8.php?edit_form=<?php echo $edit_id1 ;?>" enctype="multipart/form-data">
	<table align="center" border="1" width="800">
		<tr>
			<td align="center" colspan="5" bgcolor="yellow">
			<h1>Edit New Photo Here</h1>
			<h2>Pre/Post wedding part</h2>
			</td>
		</tr>
		<tr>
	<td>Post image:</td>
			<td><input type="file" name="image"></td>
			<img src="../upload_weddingshoots/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
	...
	if($post_image_size<=9000000)
			{
				...
				move_uploaded_file($post_image_tmp,"../upload_prepostwed/$post_image");
				$update_query="update weddingshoots set wedd_image='$post_image'where wedd_id='$update_id'";
