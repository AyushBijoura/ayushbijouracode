...
<html>
	...
	<aside>
	<marquee scrollamount="8"><h3>If a error message like "Image type invalid" appears while uploading a image,please convert that image to appropriate image format.Format for images allowed are :-JPEG,GIF,PNG,JPG.The size of the should not be larger.It is recommended that please compress the size of the image.The size of image should be in "KB's".</h1></marquee>
	...
	<div id="abc">
	<!--<marquee scrollamount="8"><h1>If a error message like "Image type invalid" appears while uploading a image,please convert that image to approprite image format.Format for images allowed are :-JPEG,GIF,PNG,JPG.The size of the should not be larger.It is recommended that please compress the size of the image.The size of image should be in "KB's".</h1></marquee>-->
	</div>
