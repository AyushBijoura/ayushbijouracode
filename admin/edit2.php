...
$query = "select * from fashionmen where fmen_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['fmen_id'];
...
<html>
	...
	<body>
	<form method="post" action="edit2.php?edit_form=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
	<table align="center" border="1" width="800">
		<tr>
			<td align="center" colspan="5" bgcolor="yellow">
			<h1>Edit New Photo Here</h1>
			<h2>Fashionmen part</h2>
			</td>
		</tr>
		<tr>
	<td>Post image:</td>
			<td><input type="file" name="image"></td>
			<img src="../upload_fmen/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
		...
		if($post_image_size<=9000000)
			{
				...
				move_uploaded_file($post_image_tmp,"../upload_fmen/$post_image");
				$update_query="update fashionmen set fmen_image='$post_image'where fmen_id='$update_id'";
