...
$query = "select * from event where events_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['events_id'];
				$image = $row['events_image'];
...
<html>
	...
	<body>
	<form method="post" action="edit4.php?edit_form=<?php echo $edit_id1; ?>" enctype="multipart/form-data">
	...
	<td>Post image:</td>
			...
			<img src="../upload_event/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
		...
		if($post_image_size<=9000000)
			{
						...
						move_uploaded_file($post_image_tmp,"../upload_event/$post_image");
						$update_query="update event set events_image='$post_image'where events_id='$update_id'";
