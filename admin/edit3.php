...
$query = "select * from family where family_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['family_id'];
...
<html>
	...
	<body>
	<form method="post" action="edit3.php?edit_form=<?php echo $edit_id1 ;?>" enctype="multipart/form-data">
	...
	<td>Post image:</td>
			...
			<img src="../upload_family/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
...
if(isset($_POST['update']))
{
	...
	if($post_image_size<=9000000)
			
			{
						...
						move_uploaded_file($post_image_tmp,"../upload_family/$post_image");
						$update_query="update family set family_image='$post_image'where family_id='$update_id'";
