...
<h3><a href="dufeedback.php?view=view">(Delete/Update)Feedback</a></h3>	
	...
	<form method="post" action="insert_eventphoto.php" enctype="multipart/form-data">
	...
	if(isset($_POST['submit']))
	{
		...
		if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="image/gif" or $image_type=="image/jpg" )
		{
			...
			{
					move_uploaded_file($image_tmp,"../upload_event/$image_name");

		$query = "insert into event(events_image) values ('$image_name')";
