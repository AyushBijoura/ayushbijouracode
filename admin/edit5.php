...
$query = "select * from couple where couple_id = '$edit_id'";

$run = mysql_query($query);
		while($row=mysql_fetch_array($run))
			{
				
				$edit_id1 = $row['couple_id'];
...
<html>
	...
	<body>
	<form method="post" action="edit5.php?edit_form=<?php echo $edit_id1 ;?>" enctype="multipart/form-data">
	...
	<td>Post image:</td>
			...
			<img src="../upload_couple/<?php echo $image;?>" width="100" height="100">
		</tr>
		<tr>
	...
	if($post_image_size<=9000000)
			{
						...
						move_uploaded_file($post_image_tmp,"../upload_couple/$post_image");
	$update_query="update couple set couple_image='$post_image'where couple_id='$update_id'";
