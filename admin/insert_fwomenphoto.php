...
<h3><a href="dufeedback.php?view=view">(Delete/Update)Feedback</a></h3>	
	...
	<form method="post" action="insert_fwomenphoto.php" enctype="multipart/form-data">
	<table align="center" border="1" width="800">
		<tr>
			<td align="center" colspan="5" bgcolor="yellow">
			<h1>Insert New Photo Here</h1>
			<h2>Fashionwomen part </h2>
		<tr>
			<td>Post image:</td>
	...
	if(isset($_POST['submit']))
	{
		...
		if($image_type=="image/jpeg" or $image_type=="image/png" or $image_type=="image/gif" or $image_type=="image/jpg" )
		{
			...
			{
					move_uploaded_file($image_tmp,"../upload_fwomen/$image_name");
						 $query = "insert into fashionwomen(fwomen_image) values ('$image_name')";
