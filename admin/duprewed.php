...
<h3><a href="dufeedback.php?view=view">(Delete/Update)Feedback</a></h3>	
	...
	<tr align="center">
		<td><?php echo $i++?></td>
		<td><img src="../upload_prepostwed/<?php echo $image?>" width="100" height="100"></td>
		<td><a href="edit7.php?edit=<?php echo $id; ?>">Edit</a></td>
		<td><a href="deleteprewwed.php?del=<?php echo $id;?>">Delete</td>
		</tr>
